...
//emit stage to Kafka
e = {$emit : { connectionName : "deltaMSK", topic : "dtx"}}
...
doc = {$source : {documents : [{test : 1}]}}
uuid = {$project : {uuidval : {$createUUID :{}}}}
sp.process([doc,uuid])
...
db.aggregate([
    { $unionWith: {  pipeline: [ 
        {$documents : [{ID : 1, ACTION : "CREATE", time : ISODate("2025-01-01T19:01:01.001Z")}, 
        {ID : 2, ACTION : "VOID",  time : ISODate("2025-01-01T19:01:07.001Z")},
        {ID : 3, ACTION : "VOID",  time : ISODate("2025-01-01T19:01:06.001Z")},
        {ID : 4, ACTION : "VOID",  time : ISODate("2025-01-01T19:01:06.001Z"), optype : "DELETE"}
       ]},
